...
export const Qa = () => {
  ...
  return (
    <div className="font-sans text-gray-900 scroll-smooth bg-neutral-100 min-h-screen">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-16 text-center">
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8 leading-relaxed">
            Let's discuss your testing requirements and create a comprehensive QA strategy.
          </p>

          <button className="bg-white text-blue-800 font-bold px-10 py-4 rounded-full hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-lg">
            Contact Us
          </button>
        </div>
      </section>
